                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        SizedBox(height: 75,),
                                        Text(
                                          '${_productDetail.productDetail.cat_name} -> ${_productDetail.productDetail.subcat_name} ',
                                          textAlign: TextAlign.center,
                                          style: Theme.of(context).primaryTextTheme.bodyText1.copyWith(fontWeight: FontWeight.bold,fontSize: 11),
                                        ),
                                        SizedBox(height: 5,),
                                        Text(
