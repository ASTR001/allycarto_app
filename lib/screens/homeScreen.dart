...
import 'CategoryShopListScreen.dart';
import 'new/subCategory.dart';
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        //   children: [
                        //     SizedBox(width: 12,),
                        //     Text("Erode 1.0 ",style: TextStyle(color: Colors.white,fontSize: 11),),
                        //     Icon(Icons.shop,color: Colors.white,size: 26,),
                        //     SizedBox(width: 4,),
                        //   ],
                        // ),
                      ],
        ...
        _widgetList.add(
          InkWell(
            onTap: () {
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (context) => SubCategoryScreen(catId: _mainCategoryData[i]["cat_id"].toString(), name:_mainCategoryData[i]["title"]),
                ),
              );
            },
            child: Container(
