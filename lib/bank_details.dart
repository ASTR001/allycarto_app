        ...
        body: Padding(
          ...
          child: _isDataLoaded
              ...
              child:  Column(
                children: [
                  Visibility(
                    visible: _bankList["bank_name"] != null ? false : true,
                    child: InkWell(
                      onTap: () {
                    ...
                    children: [
                      ListTile(
                        ...
                        subtitle: Column(
                          ...
                          children: [
                            Text(
                              _bankList["bank_name"] != null ? _bankList["bank_name"] : "",
                              style: TextStyle(fontSize: 15, color: Colors.black87),
                            ),
                            SizedBox(height: 6,),
                            Text(
                              _bankList["bank_account"] != null ? _bankList["bank_account"] : "",
                              style: TextStyle(fontSize: 15,color: Colors.black87),
                            ),
                            SizedBox(height: 6,),
                            Text(
                              _bankList["bank_ifsc"] != null ? _bankList["bank_ifsc"] : "",
                              style: TextStyle(fontSize: 15, color: Colors.black87),
                            ),
                            SizedBox(height: 2,),
                            Row(
                                ...
                                IconButton(
                                    onPressed: () {
                                      Navigator.of(context)
                                          .push(
                                        MaterialPageRoute(
                                          builder: (context) => AddBankDetails("0",_bankList["bank_name"],_bankList["bank_account"],_bankList["bank_ifsc"],_bankList["account_holder"],_bankList["pan_number"], a: widget.analytics, o: widget.observer),
                                        ),
                                      )
                                          .then((value) async {
                                        if (value != null && value) {
